 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qc="storage";function d_(n=us(),e){n=te(n);const r=qr(n,qc).getImmediate({identifier:e}),i=nl("storage");return i&&f_(r,...i),r}function f_(n,e,t,r={}){u_(n,e,t,r)}function p_(n,{instanceIdentifier:e}){const t=n.getProvider("app").getImmediate(),r=n.getProvider("auth-internal"),i=n.getProvider("app-check-internal");return new h_(t,r,i,e,kt)}function m_(){At(new lt(qc,p_,"PUBLIC").setMultipleInstances(!0)),Oe(Xa,Ya,""),Oe(Xa,Ya,"esm2017")}m_();const g_={apiKey:"AIzaSyDeyNH-n8EyllTyWsbb3dCNOQrHE6OiotI",authDomain:"mehlej-joyeria-d4e69.firebaseapp.com",projectId:"mehlej-joyeria-d4e69",storageBucket:"mehlej-joyeria-d4e69.firebasestorage.app",messagingSenderId:"359017632725",appId:"1:359017632725:web:59d2e8fa031687bf12235c"};let Vn;try{Vn=Ki(g_)}catch(n){console.error("Error initializing Firebase:",n),Vn=Ki({apiKey:"demo-api-key",authDomain:"demo-project.firebaseapp.com",projectId:"demo-project",storageBucket:"demo-project.appspot.com",messagingSenderId:"123456789",appId:"demo-app-id"})}const D_=pp(Vn),O_=kg(Vn);d_(Vn);export{nt as G,D_ as a,Cg as b,__ as c,S_ as d,O_ as e,C_ as f,P_ as g,k_ as h,b_ as i,y_ as j,T_ as k,E_ as o,I_ as s,v_ as u};
